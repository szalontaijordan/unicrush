// Generated by delombok at Tue Apr 10 09:25:15 GMT 2018
...
public class Candy implements Comparable<Candy> {
    ...
    public static State getRandomColorState() {
        return Arrays.asList(State.values()).get((int) (Math.random() * (State.values().length - 1)) + 1);
    }
    ...
    public static State getStateFromChar(char c) {
        return Arrays.stream(State.values()).filter(s -> s.toString().charAt(0) == c).findFirst().orElse(null);
    }
     ...
     */
    @java.lang.SuppressWarnings("all")
    public void setMarkedForPop(final boolean markedForPop) {
